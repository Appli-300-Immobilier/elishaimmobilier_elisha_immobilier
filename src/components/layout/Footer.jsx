...
<li>- 0703313371</li>
            <li>Email: contact@elishaimmobilierelishaimmobilier.cm</li>
            
            
            <li className="flex items-center gap-4 pt-2">
              <a href="https://www.tiktok.com/@elishaimmobilier" target="_blank" rel="noopener noreferrer" className="p-2 bg-black text-white rounded-full hover:scale-110 transition-transform shadow-lg" title="TikTok">
